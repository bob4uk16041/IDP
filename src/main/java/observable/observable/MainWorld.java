...
public class MainWorld {
    ...
    public static void main(String [] args) {
        ...
        System.out.println("InternetProvider news count: " + internetProvider.getAllNews().size());
        System.out.println("TvProvider news count: " + tvProvider.getAllNews().size());
        tvProvider.clearHistoryNews();
        internetProvider.clearHistoryNews();
